...
public:
    ...
    {
        // Passwordcoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Passwordcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Passwordcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Passwordcoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Passwordcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Passwordcoin: block index flags
    enum  
    {
