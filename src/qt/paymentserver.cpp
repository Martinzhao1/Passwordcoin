...
const QString BITCOIN_IPC_PREFIX("Passwordcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Passwordcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Passwordcoin: click-to-pay handler");
    else
...
{
    // clicking on Passwordcoin: URLs creates FileOpen events on the Mac:
